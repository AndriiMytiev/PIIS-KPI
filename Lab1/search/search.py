    ...
    while not fringePQ.isEmpty():
        ...
        if currentNode not in closed:
            ...
            for child in successors:
                ...
                fringePQ.push((successor, currentActions + [action]),
                              problem.getCostOfActions(currentActions) + stepCost + heuristic(successor, problem))
    return []
...
def greedyAStarSearch(problem: SearchProblem, heuristic=nullHeuristic):
    ...
    while not fringePQ.isEmpty():
        ...
        if currentNode not in closed:
            ...
            for child in successors:
                successor, action, stepCost = child
                fringePQ.push((successor, currentActions + [action]), heuristic(successor, problem))
    return []
